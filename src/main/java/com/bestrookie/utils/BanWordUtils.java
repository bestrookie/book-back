...
class BadWordUtils {
    public static String filePath = "D:\\resources\\banwords\\banword.txt";//敏感词库文件路径
...
//        Boolean i77 = BadWordUtils.isContaintBadWord("崇拜", 1);
        System.out.println(BadWordUtils.isContaintBadWord("我亲自杀鸡给你吃", 1));
